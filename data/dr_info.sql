...
INSERT INTO `dr_server_ccfinfo` VALUES ('6', 'TCAD', 'IEEE Transactions on Computer-Aided Design of \nIntegrated Circuits And System', 'IEEE', 'http://dblp.uni-trier.de/db/journals/tcad/', 'A', '计算机体系结构/并行与分布计算/存储系统', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('19', 'JETC', 'ACM Journal on Emerging Technologies in \nComputing Systems', 'ACM', 'http://dblp.uni-trier.de/db/journals/jetc/', 'C', '计算机体系结构/并行与分布计算/存储系统', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('20', 'nan', 'Concurrency and Computation: Practice and \nExperience', 'Wiley', 'http://dblp.uni-trier.de/db/journals/concurrency/', 'C', '计算机体系结构/并行与分布计算/存储系统', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('25', 'JETTA', 'Journal of Electronic Testing-Theory and \nApplications', 'Springer', 'http://link.springer.com/journal/10836', 'C', '计算机体系结构/并行与分布计算/存储系统', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('27', 'MICPRO', 'Microprocessors and Microsystems: Embedded \nHardware Design', 'Elsevier', 'http://dblp.uni-trier.de/db/journals/mam/', 'C', '计算机体系结构/并行与分布计算/存储系统', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('30', 'PPoPP', 'ACM SIGPLAN Symposium on Principles & \nPractice of Parallel Programming', 'ACM', 'http://dblp.uni-trier.de/db/conf/ppopp/', 'A', '计算机体系结构/并行与分布计算/存储系统', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('34', 'MICRO', 'IEEE/ACM International Symposium on \nMicroarchitecture', 'IEEE/ACM', 'https://dblp.uni-trier.de/db/conf/micro/', 'A', '计算机体系结构/并行与分布计算/存储系统', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('35', 'SC', 'International Conference for High Performance \nComputing, Networking, Storage, and Analysis', 'IEEE', 'http://dblp.uni-trier.de/db/conf/sc/', 'A', '计算机体系结构/并行与分布计算/存储系统', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('36', 'ASPLOS', 'International Conference on Architectural Support \nfor Programming Languages and Operating Systems', 'ACM', 'http://dblp.uni-trier.de/db/conf/asplos/', 'A', '计算机体系结构/并行与分布计算/存储系统', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('42', 'FPGA', 'ACM/SIGDA International Symposium on Field-Programmable \nGate Arrays', 'ACM', 'http://dblp.uni-trier.de/db/conf/fpga/', 'B', '计算机体系结构/并行与分布计算/存储系统', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('51', 'CODES+ISSS', 'International Conference on Hardware/Software Co-design and \nSystem Synthesis', 'ACM/ IEEE', 'http://dblp.uni-trier.de/db/conf/codes/index.html', 'B', '计算机体系结构/并行与分布计算/存储系统', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('52', 'HiPEAC', 'International Conference on High Performance and Embedded \nArchitectures and Compilers', 'ACM', 'http://dblp.uni-trier.de/db/conf/hipeac/', 'B', '计算机体系结构/并行与分布计算/存储系统', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('53', 'PACT', 'International Conference on Parallel Architectures and \nCompilation Techniques', 'IEEE/ACM', 'http://dblp.uni-trier.de/db/conf/IEEEpact/', 'B', '计算机体系结构/并行与分布计算/存储系统', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('58', 'Performance', 'International Symposium on Computer Performance Modeling, \nMeasurements and Evaluation', 'ACM', 'http://dblp.uni-trier.de/db/conf/performance/', 'B', '计算机体系结构/并行与分布计算/存储系统', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('59', 'HPDC', 'International Symposium on High Performance Distributed \nComputing', 'IEEE', 'http://dblp.uni-trier.de/db/conf/hpdc/', 'B', '计算机体系结构/并行与分布计算/存储系统', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('63', 'RTAS', 'Real-Time and Embedded Technology and Applications \nSymposium', 'IEEE', 'http://dblp.uni-trier.de/db/conf/rtas/', 'B', '计算机体系结构/并行与分布计算/存储系统', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('75', 'HPCC', 'IEEE International Conference on High Performance \nComputing and Communications', 'IEEE', 'http://dblp.uni-trier.de/db/conf/hpcc/', 'C', '计算机体系结构/并行与分布计算/存储系统', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('76', 'HiPC', 'IEEE International Conference on High Performance \nComputing, Data and Analytics', 'IEEE/ ACM', 'http://dblp.uni-trier.de/db/conf/hipc/index.html', 'C', '计算机体系结构/并行与分布计算/存储系统', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('77', 'MASCOTS', 'IEEE International Symposium on Modeling, Analysis, and \nSimulation of Computer and Telecommunication Systems', 'IEEE', 'http://dblp.uni-trier.de/db/conf/mascots/', 'C', '计算机体系结构/并行与分布计算/存储系统', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('78', 'CCGRID', 'IEEE/ACM International Symposium on Cluster, Cloud and \nGrid Computing', 'ACM/IEEE', 'http://dblp.uni-trier.de/db/conf/ccgrid/', 'C', '计算机体系结构/并行与分布计算/存储系统', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('79', 'NPC', 'IFIP International Conference on Network and Parallel \nComputing', 'Springer', 'http://dblp.uni-trier.de/db/conf/npc/', 'C', '计算机体系结构/并行与分布计算/存储系统', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('80', 'ICA3PP', 'International Conference on Algorithms and Architectures for \nParallel Processing', 'IEEE', 'http://dblp.uni-trier.de/db/conf/ica3pp/', 'C', '计算机体系结构/并行与分布计算/存储系统', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('81', 'CASES', 'International Conference on Compilers, Architectures, and \nSynthesis for Embedded Systems', 'ACM', 'http://dblp.uni-trier.de/db/conf/cases/index.html', 'C', '计算机体系结构/并行与分布计算/存储系统', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('85', 'ISLPED', 'International Symposium on Low Power Electronics and \nDesign', 'ACM/IEEE', 'http://dblp.uni-trier.de/db/conf/islped/', 'C', '计算机体系结构/并行与分布计算/存储系统', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('93', 'TOMCCAP', 'ACM Transactions on Multimedia Computing, \nCommunications and Applications', 'ACM', 'http://dblp.uni-trier.de/db/journals/tomccap/', 'B', '计算机网络', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('100', 'TNSM', 'IEEE Transactions on Network and Service \nManagement', 'IEEE', 'http://dblp.uni-trier.de/db/journals/tnsm/', 'C', '计算机网络', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('108', 'SIGCOMM', 'ACM International Conference on Applications, \nTechnologies, Architectures, and Protocols for \nComputer Communication', 'ACM', 'http://dblp.uni-trier.de/db/conf/sigcomm/index.html', 'A', '计算机网络', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('109', 'MobiCom', 'ACM International Conference on Mobile \nComputing and Networking', 'ACM', 'http://dblp.uni-trier.de/db/conf/mobicom/', 'A', '计算机网络', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('110', 'INFOCOM', 'IEEE International Conference on Computer \nCommunications', 'IEEE', 'http://dblp.uni-trier.de/db/conf/infocom/', 'A', '计算机网络', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('111', 'NSDI', 'Symposium on Network System Design and \nImplementation', 'USENIX', 'http://dblp.uni-trier.de/db/conf/nsdi/', 'A', '计算机网络', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('113', 'CoNEXT', 'ACM International Conference on Emerging Networking \nExperiments and Technologies', 'ACM', 'http://dblp.uni-trier.de/db/conf/conext/', 'B', '计算机网络', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('114', 'SECON', 'IEEE Communications Society Conference on Sensor and Ad Hoc \nCommunications and Networks', 'IEEE', 'http://dblp.uni-trier.de/db/conf/secon/', 'B', '计算机网络', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('115', 'IPSN', 'International Conference on Information Processing in Sensor \nNetworks', 'IEEE/ACM', 'http://dblp.uni-trier.de/db/conf/ipsn/', 'B', '计算机网络', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('116', 'MobiSys', 'International Conference on Mobile Systems, Applications, and \nServices', 'ACM', 'http://dblp.uni-trier.de/db/conf/mobisys/', 'B', '计算机网络', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('118', 'MobiHoc', 'International Symposium on Mobile Ad Hoc Networking and \nComputing', 'ACM/IEEE', 'http://dblp.uni-trier.de/db/conf/mobihoc/', 'B', '计算机网络', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('119', 'NOSSDAV', 'International Workshop on Network and Operating System Support \nfor Digital Audio and Video', 'ACM', 'http://dblp.uni-trier.de/db/conf/nossdav/', 'B', '计算机网络', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('128', 'ICCCN', 'IEEE International Conference on Computer Communications and \nNetworks', 'IEEE', 'http://dblp.uni-trier.de/db/conf/icccn/', 'C', '计算机网络', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('131', 'IPCCC', 'IEEE International Performance Computing and Communications \nConference', 'IEEE', 'http://dblp.uni-trier.de/db/conf/ipccc/', 'C', '计算机网络', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('132', 'WoWMoM', 'IEEE International Symposium on a World of Wireless, Mobile and \nMultimedia Networks', 'IEEE', 'http://dblp.uni-trier.de/db/conf/wowmom/', 'C', '计算机网络', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('136', 'IM', 'IFIP/IEEE International Symposium on Integrated Network \nManagement', 'IFIP/IEEE', 'http://dblp.uni-trier.de/db/conf/im/index.html', 'C', '计算机网络', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('138', 'MSWiM', 'International Conference on Modeling, Analysis and Simulation of \nWireless and Mobile Systems', 'ACM', 'http://dblp.uni-trier.de/db/conf/mswim/', 'C', '计算机网络', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('139', 'WASA', 'International Conference on Wireless Algorithms, Systems, and \nApplications', 'Springer', 'http://dblp.uni-trier.de/db/conf/wasa/', 'C', '计算机网络', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('144', 'TISSEC', 'ACM Transactions on Information and System \nSecurity', 'ACM', 'http://dblp.uni-trier.de/db/journals/tissec/', 'B', '网络与信息安全', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('156', 'CCS', 'ACM Conference on Computer and \nCommunications Security', 'ACM', 'http://dblp.uni-trier.de/db/conf/ccs/', 'A', '网络与信息安全', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('162', 'ASIACRYPT', 'Annual International Conference on the Theory and \nApplication of Cryptology and Information Security', 'Springer', 'http://dblp.uni-trier.de/db/conf/asiacrypt/', 'B', '网络与信息安全', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('166', 'SRDS', 'IEEE International Symposium on Reliable Distributed \nSystems', 'IEEE', 'http://dblp.uni-trier.de/db/conf/srds/', 'B', '网络与信息安全', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('167', 'CHES', 'International Conference on Cryptographic Hardware and \nEmbedded Systems', 'Springer', 'http://dblp.uni-trier.de/db/conf/ches/', 'B', '网络与信息安全', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('168', 'DSN', 'International Conference on Dependable Systems and \nNetworks', 'IEEE/IFIP', 'http://dblp.uni-trier.de/db/conf/dsn/', 'B', '网络与信息安全', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('169', 'RAID', 'International Symposium on Recent Advances in Intrusion \nDetection', 'Springer', 'http://dblp.uni-trier.de/db/conf/raid/', 'B', '网络与信息安全', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('170', 'PKC', 'International Workshop on Practice and Theory in Public \nKey Cryptography', 'Springer', 'http://dblp.uni-trier.de/db/conf/pkc/', 'B', '网络与信息安全', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('171', 'NDSS', 'ISOC Network and Distributed System Security \nSymposium', 'ISOC', 'http://dblp.uni-trier.de/db/conf/ndss/', 'B', '网络与信息安全', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('173', 'WiSec', 'ACM Conference on Security and Privacy in Wireless and \nMobile Networks', 'ACM', 'http://dblp.uni-trier.de/db/conf/wisec/', 'C', '网络与信息安全', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('174', 'SACMAT', 'ACM Symposium on Access Control Models and \nTechnologies', 'ACM', 'http://dblp.uni-trier.de/db/conf/sacmat/', 'C', '网络与信息安全', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('176', 'IH&MMSec', 'ACM Workshop on Information Hiding and Multimedia \nSecurity', 'ACM', 'http://dblp.uni-trier.de/db/conf/ih/', 'C', '网络与信息安全', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('181', 'DIMVA', 'Detection of Intrusions and Malware & Vulnerability \nAssessment', 'nan', 'http://dblp.uni-trier.de/db/conf/dimva/', 'C', '网络与信息安全', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('184', 'TrustCom', 'IEEE International Conference on Trust, Security and Privacy \nin Computing and Communications', 'IEEE', 'http://dblp.uni-trier.de/db/conf/trustcom/', 'C', '网络与信息安全', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('188', 'ICICS', 'International Conference on Information and Communications \nSecurity', 'Springer', 'http://dblp.uni-trier.de/db/conf/icics/', 'C', '网络与信息安全', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('189', 'SecureComm', 'International Conference on Security and Privacy in \nCommunication Networks', 'ACM', 'http://dblp.uni-trier.de/db/conf/securecom\nm/', 'C', '网络与信息安全', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('213', 'IJSEKE', 'International Journal on Software Engineering and \nKnowledge Engineering', 'World Scientific', 'http://dblp.uni-trier.de/db/journals/ijseke/index.html', 'C', '软件工程/系统软件/程序设计语言', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('214', 'STTT', 'International Journal on Software Tools for Technology \nTransfer', 'Springer', 'http://dblp.uni-trier.de/db/journals/sttt/', 'C', '软件工程/系统软件/程序设计语言', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('220', 'PLDI', 'ACM SIGPLAN Conference on Programming Language Design & \nImplementation', 'ACM', 'http://dblp.uni-trier.de/db/conf/pldi/', 'A', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('221', 'POPL', 'ACM SIGPLAN-SIGACT Symposium on Principles of Programming \nLanguages', 'ACM', 'http://dblp.uni-trier.de/db/conf/popl/', 'A', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('222', 'FSE/ESEC', 'ACM SIGSOFT Symposium on the Foundation of Software Engineering/ \nEuropean Software Engineering Conference', 'ACM', 'http://dblp.uni-trier.de/db/conf/sigsoft/', 'A', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('224', 'OOPSLA', 'Conference on Object-Oriented Programming Systems, Languages, and \nApplications', 'ACM', 'http://dblp.uni-trier.de/db/conf/oopsla/', 'A', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('230', 'ETAPS', 'European Joint Conferences on Theory and Practice of \nSoftware', 'Springer', 'http://dblp.uni-trier.de/db/conf/etaps/', 'B', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('231', 'ICPC', 'IEEE International Conference on Program \nComprehension', 'IEEE', 'http://dblp.uni-trier.de/db/conf/iwpc/', 'B', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('233', 'CAiSE', 'International Conference on Advanced Information \nSystems Engineering', 'Springer', 'http://dblp.uni-trier.de/db/conf/caise/', 'B', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('235', 'LCTES', 'International Conference on Languages, Compilers and \nTools for Embedded Systems', 'ACM', 'http://dblp.uni-trier.de/db/conf/lctrts/', 'B', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('236', 'MoDELS', 'International Conference on Model Driven Engineering \nLanguages and Systems', 'ACM, IEEE', 'http://dblp.uni-trier.de/db/conf/models/', 'B', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('237', 'CP', 'International Conference on Principles and Practice of \nConstraint Programming', 'Springer', 'http://dblp.uni-trier.de/db/conf/cp/', 'B', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('239', 'ICSME', 'International Conference on Software Maintenance and \nEvolution', 'IEEE', 'http://dblp.uni-trier.de/db/conf/icsm/', 'B', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('240', 'VMCAI', 'International Conference on Verification, Model Checking, \nand Abstract Interpretation', 'Springer', 'http://dblp.uni-trier.de/db/conf/vmcai/', 'B', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('241', 'ICWS', 'International Conference on Web Services （Research \nTrack）', 'IEEE', 'http://dblp.uni-trier.de/db/conf/icws/', 'B', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('244', 'ESEM', 'International Symposium on Empirical Software \nEngineering and Measurement', 'ACM/IEEE', 'http://dblp.uni-trier.de/db/conf/esem/', 'B', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('246', 'ISSRE', 'International Symposium on Software Reliability \nEngineering', 'IEEE', 'http://dblp.uni-trier.de/db/conf/issre/', 'B', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('248', 'PEPM', 'ACM SIGPLAN Workshop on Partial Evaluation and Program \nManipulation', 'ACM', 'http://dblp.uni-trier.de/db/conf/pepm/', 'C', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('249', 'PASTE', 'ACMSIGPLAN-SIGSOFT Workshop on Program Analysis \nfor Software Tools and Engineering', 'ACM', 'http://dblp.uni-trier.de/db/conf/paste/', 'C', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('253', 'ICECCS', 'IEEE International Conference on Engineering of Complex \nComputer Systems', 'IEEE', 'http://dblp.uni-trier.de/db/conf/iceccs/', 'C', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('254', 'ICST', 'IEEE International Conference on Software Testing, \nVerification and Validation', 'IEEE', 'http://dblp.uni-trier.de/db/conf/icst/', 'C', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('255', 'ISPASS', 'IEEE International Symposium on Performance Analysis of \nSystems and Software', 'IEEE', 'http://dblp.uni-trier.de/db/conf/ispass/', 'C', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('256', 'SCAM', 'IEEE International Working Conference on Source Code \nAnalysis and Manipulation', 'IEEE', 'http://dblp.uni-trier.de/db/conf/scam/', 'C', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('258', 'TOOLS', 'International Conference on Objects, Models, Components, \nPatterns', 'Springer', 'http://dblp.uni-trier.de/db/conf/tools/index.html', 'C', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('262', 'SEKE', 'International Conference on Software Engineering and \nKnowledge Engineering', 'KSI', 'http://dblp.uni-trier.de/db/conf/seke/', 'C', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('266', 'ATVA', 'International Symposium on Automated Technology for \nVerification and Analysis', 'Springer', 'http://dblp.uni-trier.de/db/conf/atva/', 'C', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('267', 'LOPSTR', 'International Symposium on Logic-based Program Synthesis \nand Transformation', 'Springer', 'http://dblp.uni-trier.de/db/conf/lopstr/', 'C', '软件工程/系统软件/程序设计语言', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('268', 'TASE', 'International Symposium on Theoretical Aspects of Software \nEngineering', 'IEEE', 'http://dblp.uni-trier.de/db/conf/tase/', 'C', '软件工程/系统软件/程序设计语言', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('276', 'TKDD', 'ACM Transactions on Knowledge \nDiscovery from Data', 'ACM', 'http://dblp.uni-trier.de/db/journals/tkdd/', 'B', '数据库/数据挖掘/内容检索', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('281', 'EJIS', 'European Journal of Information \nSystems', 'Springer', 'http://dblp.uni-trier.de/db/journals/ejis/', 'B', '数据库/数据挖掘/内容检索', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('286', 'JASIST', 'Journal of the American Society for \nInformation Science and Technology', 'American Society for \nInformation Science and \nTechnology', 'http://dblp.uni-trier.de/db/journals/jasis/', 'B', '数据库/数据挖掘/内容检索', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('294', 'IJGIS', 'International Journal of Geographical Information \nScience', 'Taylor & Francis', 'http://dblp.uni-trier.de/db/journals/gis/', 'C', '数据库/数据挖掘/内容检索', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('297', 'IJSWIS', 'International Journal on Semantic Web and Information \nSystems', 'IGI', 'http://dblp.uni-trier.de/db/journals/ijswis/', 'C', '数据库/数据挖掘/内容检索', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('305', 'ICDE', 'IEEE International Conference on Data \nEngineering', 'IEEE', 'http://dblp.uni-trier.de/db/conf/icde/', 'A', '数据库/数据挖掘/内容检索', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('306', 'SIGIR', 'International Conference on Research on \nDevelopment in Information Retrieval', 'ACM', 'http://dblp.uni-trier.de/db/conf/sigir/', 'A', '数据库/数据挖掘/内容检索', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('308', 'CIKM', 'ACM International Conference on Information \nand Knowledge Management', 'ACM', 'http://dblp.uni-trier.de/db/conf/cikm/', 'B', '数据库/数据挖掘/内容检索', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('309', 'WSDM', 'ACM International Conference on Web Search \nand Data Mining', 'ACM', 'http://dblp.uni-trier.de/db/conf/wsdm/', 'B', '数据库/数据挖掘/内容检索', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('310', 'PODS', 'ACM Symposium on Principles of Database \nSystems', 'ACM', 'http://dblp.uni-trier.de/db/conf/pods/', 'B', '数据库/数据挖掘/内容检索', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('312', 'ECML-PKDD', 'European Conference on Machine Learning \nand Principles and Practice of Knowledge \nDiscovery in Databases', 'Springer', 'http://dblp.uni-trier.de/db/conf/ecml/ \nhttp://dblp.uni-trier.de/db/conf/pkdd/', 'B', '数据库/数据挖掘/内容检索', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('316', 'EDBT', 'International Conference on Extending DB \nTechnology', 'Springer', 'http://dblp.uni-trier.de/db/conf/edbt/', 'B', '数据库/数据挖掘/内容检索', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('317', 'CIDR', 'International Conference on Innovative Data \nSystems Research', 'Online Proceeding', 'http://dblp.uni-trier.de/db/conf/cidr/', 'B', '数据库/数据挖掘/内容检索', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('318', 'SDM', 'SIAM International Conference on Data \nMining', 'SIAM', 'http://dblp.uni-trier.de/db/conf/sdm/', 'B', '数据库/数据挖掘/内容检索', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('323', 'WebDB', 'International ACM Workshop on Web and \nDatabases', 'ACM', 'http://dblp.uni-trier.de/db/conf/webdb/', 'C', '数据库/数据挖掘/内容检索', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('324', 'ER', 'International Conference on Conceptual \nModeling', 'Springer', 'http://dblp.uni-trier.de/db/conf/er/', 'C', '数据库/数据挖掘/内容检索', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('325', 'MDM', 'International Conference on Mobile Data \nManagement', 'IEEE', 'http://dblp.uni-trier.de/db/conf/mdm/', 'C', '数据库/数据挖掘/内容检索', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('326', 'SSDBM', 'International Conference on Scientific and \nStatistical DB Management', 'IEEE', 'http://dblp.uni-trier.de/db/conf/ssdbm/', 'C', '数据库/数据挖掘/内容检索', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('327', 'WAIM', 'International Conference on Web Age \nInformation Management', 'Springer', 'http://dblp.uni-trier.de/db/conf/waim/', 'C', '数据库/数据挖掘/内容检索', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('328', 'SSTD', 'International Symposium on Spatial and \nTemporal Databases', 'Springer', 'http://dblp.uni-trier.de/db/conf/ssd/', 'C', '数据库/数据挖掘/内容检索', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('329', 'PAKDD', 'Pacific-Asia Conference on Knowledge \nDiscovery and Data Mining', 'Springer', 'http://dblp.uni-trier.de/db/conf/pakdd/', 'C', '数据库/数据挖掘/内容检索', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('367', 'ICALP', 'International Colloquium on Automata, Languages and \nProgramming', 'Springer', 'http://dblp.uni-trier.de/db/conf/icalp/', 'B', '计算机科学理论', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('368', 'CADE/IJCAR', 'International Conference on Automated \nDeduction/International Joint Conference on \nAutomated Reasoning', 'Springer', 'http://dblp.uni-trier.de/db/conf/cade/', 'B', '计算机科学理论', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('370', 'HSCC', 'International Conference on Hybrid Systems: \nComputation and Control', 'Springer and ACM', 'http://dblp.uni-trier.de/db/conf/hybrid/', 'B', '计算机科学理论', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('374', 'FSTTCS', 'Foundations of Software Technology and \nTheoretical Computer Science', 'Indian Association for Research \nin Computing Science', 'http://dblp.uni-trier.de/db/conf/fsttcs/', 'C', '计算机科学理论', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('375', 'DSAA', 'IEEE International Conference on Data Science \nand Advanced Analytics', 'IEEE', 'https://dblp.uni-trier.de/db/conf/dsaa/', 'C', '计算机科学理论', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('376', 'ICTAC', 'International Colloquium on Theoretical Aspects \nof Computing', 'Springer', 'http://dblp.uni-trier.de/db/conf/ictac/', 'C', '计算机科学理论', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('377', 'IPCO', 'International Conference on Integer Programming \nand Combinatorial Optimization', 'Springer', 'http://dblp.uni-trier.de/db/conf/ipco/', 'C', '计算机科学理论', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('378', 'RTA', 'International Conference on Rewriting \nTechniques and Applications', 'Springer', 'http://dblp.uni-trier.de/db/conf/rta/', 'C', '计算机科学理论', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('379', 'ISAAC', 'International Symposium on Algorithms and \nComputation', 'Springer', 'http://dblp.uni-trier.de/db/conf/isaac/', 'C', '计算机科学理论', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('381', 'STACS', 'Symposium on Theoretical Aspects of Computer \nScience', 'Springer', 'http://dblp.uni-trier.de/db/conf/stacs/', 'C', '计算机科学理论', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('385', 'TOMCCAP', 'ACM Transactions on Multimedia Computing, \nCommunications and Application', 'ACM', 'http://dblp.uni-trier.de/db/journals/tomccap/', 'B', '计算机图形学与多媒体', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('390', 'TCSVT', 'IEEE Transactions on Circuits and Systems for \nVideo Technology', 'IEEE', 'http://dblp.uni-trier.de/db/journals/tcsv/', 'B', '计算机图形学与多媒体', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('395', 'CGTA', 'Computational Geometry: Theory and \nApplications', 'Elsevier', 'http://dblp.uni-trier.de/db/journals/comgeo/', 'C', '计算机图形学与多媒体', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('401', 'JVCIR', 'Journal of Visual Communication and Image \nRepresentation', 'Elsevier', 'http://dblp.uni-trier.de/db/journals/jvcir/', 'C', '计算机图形学与多媒体', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('411', 'ICMR', 'ACM SIGMM International Conference on \nMultimedia Retrieval', 'ACM', 'http://dblp.uni-trier.de/db/conf/mir/', 'B', '计算机图形学与多媒体', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('413', 'SCA', 'ACM/Eurographics Symposium on Computer \nAnimation', 'ACM', 'http://dblp.uni-trier.de/db/conf/sca/index.html', 'B', '计算机图形学与多媒体', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('417', 'SGP', 'Eurographics Symposium on Geometry \nProcessing', 'Wiley/Blackwell', 'http://dblp.uni-trier.de/db/conf/sgp/', 'B', '计算机图形学与多媒体', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('419', 'ICASSP', 'IEEE International Conference on Acoustics, \nSpeech and SP', 'IEEE', 'http://dblp.uni-trier.de/db/conf/icassp/', 'B', '计算机图形学与多媒体', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('420', 'ICME', 'IEEE International Conference on \nMultimedia & Expo', 'IEEE', 'http://dblp.uni-trier.de/db/conf/icmcs/', 'B', '计算机图形学与多媒体', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('421', 'ISMAR', 'International Symposium on Mixed and \nAugmented Reality', 'IEEE/ACM', 'http://dblp.uni-trier.de/db/conf/ismar/', 'B', '计算机图形学与多媒体', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('422', 'PG', 'Pacific Graphics: The Pacific Conference on \nComputer Graphics and Applications', 'Wiley/Blackwell', 'http://dblp.uni-trier.de/db/conf/pg/index.html', 'B', '计算机图形学与多媒体', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('424', 'nan', 'ACM Symposium on Virtual Reality \nSoftware and Technology', 'ACM', 'http://dblp2.uni-trier.de/db/conf/vrst/', 'C', '计算机图形学与多媒体', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('427', 'INTERSPEECH', 'Conference of the International Speech \nCommunication Association', 'nan', 'http://dblp.uni-trier.de/db/conf/interspeech/index.html', 'C', '计算机图形学与多媒体', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('431', 'CAD/Graphics', 'International Conference on Computer-Aided \nDesign and Computer Graphics', 'IEEE', 'https://dblp.uni-trier.de/db/conf/cadgraphics/', 'C', '计算机图形学与多媒体', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('433', 'MMM', 'International Conference on Multimedia \nModeling', 'Springer', 'http://dblp.uni-trier.de/db/conf/mmm/index.html', 'C', '计算机图形学与多媒体', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('437', 'TPAMI', 'IEEE Trans on Pattern Analysis and Machine \nIntelligence', 'IEEE', 'http://dblp.uni-trier.de/db/journals/pami/', 'A', '人工智能', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('441', 'TSLP', 'ACM Transactions on Speech and Language \nProcessing', 'ACM', 'http://dblp.uni-trier.de/db/journals/tslp/', 'B', '人工智能', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('448', 'TASLP', 'IEEE Transactions on Audio, Speech, and \nLanguage Processing', 'IEEE', 'http://dblp.uni-trier.de/db/journals/taslp/', 'B', '人工智能', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('450', 'TEC', 'IEEE Transactions on Evolutionary \nComputation', 'IEEE', 'http://dblp.uni-trier.de/db/journals/tec/', 'B', '人工智能', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('452', 'TNNLS', 'IEEE Transactions on Neural Networks and \nlearning systems', 'IEEE', 'http://dblp.uni-trier.de/db/journals/tnn/', 'B', '人工智能', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('453', 'IJAR', 'International Journal of Approximate \nReasoning', 'Elsevier', 'http://dblp.uni-trier.de/db/journals/ijar/', 'B', '人工智能', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('455', 'JSLHR', 'Journal of Speech, Language, and Hearing \nResearch', 'American \nSpeech-Language \nHearing Association', 'http://jslhr.pubs.asha.org/', 'B', '人工智能', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('460', 'TALIP', 'ACM Transactions on Asian Language \nInformation Processing', 'ACM', 'http://dblp.uni-trier.de/db/journals/talip/', 'C', '人工智能', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('468', 'EAAI', 'Engineering Applications of Artificial \nIntelligence', 'Elsevier', 'http://dblp.uni-trier.de/db/journals/eaai/', 'C', '人工智能', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('476', 'IJCIA', 'International Journal of Computational \nIntelligence and Applications', 'World Scientific', 'http://dblp.uni-trier.de/db/journals/ijcia/', 'C', '人工智能', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('477', 'IJIS', 'International Journal of Intelligent \nSystems', 'Wiley', 'http://dblp.uni-trier.de/db/journals/ijis/', 'C', '人工智能', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('479', 'IJPRAI', 'International Journal of Pattern \nRecognition and Artificial Intelligence', 'World Scientific', 'http://dblp.uni-trier.de/db/journals/ijprai/', 'C', '人工智能', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('480', 'IJUFKS', 'International Journal of Uncertainty, \nFuzziness and Knowledge-Based System', 'World Scientific', 'https://dblp.uni-trier.de/db/journals/ijufks/', 'C', '人工智能', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('481', 'IJDAR', 'International Journal on Document \nAnalysis and Recognition', 'Springer', 'http://dblp.uni-trier.de/db/journals/ijdar/', 'C', '人工智能', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('482', 'JETAI', 'Journal of Experimental and Theoretical \nArtificial Intelligence', 'Taylor & Francis', 'http://dblp.uni-trier.de/db/journals/jetai/', 'C', '人工智能', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('494', 'AAAI', 'AAAI Conference on Artificial \nIntelligence', 'AAAI', 'http://dblp.uni-trier.de/db/conf/aaai/', 'A', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('495', 'NeurIPS', 'Annual Conference on Neural \nInformation Processing Systems', 'MIT Press', 'http://dblp.uni-trier.de/db/conf/nips/', 'A', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('496', 'ACL', 'Annual Meeting of the \nAssociation for Computational \nLinguistics', 'ACL', 'http://dblp.uni-trier.de/db/conf/acl/', 'A', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('497', 'CVPR', 'IEEE Conference on Computer \nVision and Pattern Recognition', 'IEEE', 'http://dblp.uni-trier.de/db/conf/cvpr/', 'A', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('498', 'ICCV', 'International Conference on \nComputer Vision', 'IEEE', 'http://dblp.uni-trier.de/db/conf/iccv/', 'A', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('499', 'ICML', 'International Conference on \nMachine Learning', 'ACM', 'http://dblp.uni-trier.de/db/conf/icml/', 'A', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('500', 'IJCAI', 'International Joint Conference on \nArtificial Intelligence', 'Morgan Kaufmann', 'http://dblp.uni-trier.de/db/conf/ijcai/', 'A', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('501', 'COLT', 'Annual Conference on \nComputational Learning Theory', 'Springer', 'http://dblp.uni-trier.de/db/conf/colt/', 'B', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('502', 'EMNLP', 'Conference on Empirical \nMethods in Natural Language \nProcessing', 'ACL', 'http://dblp.uni-trier.de/db/conf/emnlp/', 'B', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('503', 'ECAI', 'European Conference on \nArtificial Intelligence', 'IOS Press', 'http://dblp.uni-trier.de/db/conf/ecai/', 'B', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('504', 'ECCV', 'European Conference on \nComputer Vision', 'Springer', 'http://dblp.uni-trier.de/db/conf/eccv/', 'B', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('505', 'ICRA', 'IEEE International Conference on \nRobotics and Automation', 'IEEE', 'http://dblp.uni-trier.de/db/conf/icra/', 'B', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('506', 'ICAPS', 'International Conference on \nAutomated Planning and \nScheduling', 'AAAI', 'http://dblp.uni-trier.de/db/conf/aips/', 'B', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('507', 'ICCBR', 'International Conference on \nCase-Based Reasoning and \nDevelopment', 'Springer', 'http://dblp.uni-trier.de/db/conf/iccbr/', 'B', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('508', 'COLING', 'International Conference on \nComputational Linguistics', 'ACM', 'http://dblp.uni-trier.de/db/conf/coling/', 'B', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('509', 'KR', 'International Conference on \nPrinciples of Knowledge', 'Morgan Kaufmann', 'http://dblp.uni-trier.de/db/conf/kr/', 'B', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('510', 'UAI', 'International Conference on \nUncertainty in Artificial \nIntelligence', 'AUAI', 'http://dblp.uni-trier.de/db/conf/uai/', 'B', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('511', 'AAMAS', 'International Joint Conference on \nAutonomous Agents and \nMulti-agent Systems', 'Springer', 'http://dblp.uni-trier.de/db/conf/atal/index.html', 'B', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('512', 'PPSN', 'Parallel Problem Solving from \nNature', 'Springer', 'http://dblp.uni-trier.de/db/conf/ppsn/', 'B', '人工智能', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('515', 'ACML', 'Asian Conference on Machine \nLearning', 'JMLR', 'http://dblp.uni-trier.de/db/conf/acml/', 'C', '人工智能', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('517', 'NLPCC', 'CCF International Conference on \nNatural Language Processing and \nChinese Computing', 'Springer', 'https://dblp.uni-trier.de/db/conf/nlpcc/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('518', 'CoNLL', 'Conference on Computational Natural \nLanguage Learning', 'Association for \nComputational Linguistics', 'http://dblp.uni-trier.de/db/conf/conll', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('519', 'GECCO', 'Genetic and Evolutionary Computation \nConference', 'ACM', 'http://dblp.uni-trier.de/db/conf/gecco/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('520', 'ICTAI', 'IEEE International Conference on \nTools with Artificial Intelligence', 'IEEE', 'http://dblp.uni-trier.de/db/conf/ictai/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('521', 'IROS', 'IEEE\\RSJ International Conference on \nIntelligent Robots and Systems', 'IEEE', 'http://dblp.uni-trier.de/db/conf/iros/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('522', 'ALT', 'International Conference on \nAlgorithmic Learning Theory', 'Springer', 'http://dblp.uni-trier.de/db/conf/alt/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('523', 'ICANN', 'International Conference on Artificial \nNeural Networks', 'Springer', 'http://dblp.uni-trier.de/db/conf/icann/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('524', 'FG', 'International Conference on Automatic \nFace and Gesture Recognition', 'IEEE', 'http://dblp.uni-trier.de/db/conf/fgr/', 'C', '人工智能', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('526', 'ILP', 'International Conference on Inductive \nLogic Programming', 'Springer', 'http://dblp.uni-trier.de/db/conf/ilp/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('527', 'KSEM', 'International conference on Knowledge \nScience, Engineering and Management', 'Springer', 'http://dblp.uni-trier.de/db/conf/ksem/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('528', 'ICONIP', 'International Conference on Neural \nInformation Processing', 'Springer', 'http://dblp.uni-trier.de/db/conf/iconip/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('529', 'ICPR', 'International Conference on Pattern \nRecognition', 'IEEE', 'http://dblp.uni-trier.de/db/conf/icpr/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('530', 'ICB', 'International Joint Conference on \nBiometrics', 'IEEE', 'http://dblp.uni-trier.de/db/conf/icb/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('531', 'IJCNN', 'International Joint Conference on \nNeural Networks', 'IEEE', 'http://dblp.uni-trier.de/db/conf/ijcnn/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('532', 'PRICAI', 'Pacific Rim International Conference \non Artificial Intelligence', 'Springer', 'http://dblp.uni-trier.de/db/conf/pricai/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('533', 'NAACL', 'The Annual Conference of the North \nAmerican Chapter of the Association \nfor Computational Linguistics', 'NAACL', 'http://dblp.uni-trier.de/db/conf/naacl/', 'C', '人工智能', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('534', 'TOCHI', 'ACM Transactions on Computer-Human \nInteraction', 'ACM', 'http://dblp.uni-trier.de/db/journals/tochi/', 'A', '人机交互与普适计算', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('540', 'IJHCI', 'International Journal of Human-Computer \nInteraction', 'Taylor & Francis', 'http://dblp.uni-trier.de/db/journals/ijhci/', 'B', '人机交互与普适计算', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('545', 'CSCW', 'ACM Conference on Computer Supported \nCooperative Work and Social Computing', 'ACM', 'http://dblp.uni-trier.de/db/conf/cscw', 'A', '人机交互与普适计算', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('546', 'CHI', 'ACM Conference on Human Factors in \nComputing Systems', 'ACM', 'http://dblp.uni-trier.de/db/conf/chi', 'A', '人机交互与普适计算', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('547', 'UbiComp', 'ACM International Conference on Ubiquitous \nComputing', 'ACM', 'http://dblp.uni-trier.de/db/conf/huc/', 'A', '人机交互与普适计算', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('549', 'IUI', 'ACM International Conference on Intelligent User \nInterfaces', 'ACM', 'http://dblp.uni-trier.de/db/conf/iui/', 'B', '人机交互与普适计算', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('550', 'ITS', 'ACM International Conference on Interactive \nTabletops and Surfaces', 'ACM', 'http://dblp.uni-trier.de/db/conf/tabletop/', 'B', '人机交互与普适计算', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('551', 'UIST', 'ACM Symposium on User Interface Software and \nTechnology', 'ACM', 'http://dblp.uni-trier.de/db/conf/uist/', 'B', '人机交互与普适计算', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('552', 'ECSCW', 'European Conference on Computer Supported \nCooperative Work', 'Springer', 'http://dblp.uni-trier.de/db/conf/ecscw/', 'B', '人机交互与普适计算', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('553', 'PERCOM', 'IEEE International Conference on Pervasive \nComputing and Communications', 'IEEE', 'http://dblp.uni-trier.de/db/conf/percom/', 'B', '人机交互与普适计算', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('554', 'MobileHCI', 'International Conference on Human Computer \nInteraction with Mobile Devices and Services', 'ACM', 'http://dblp.uni-trier.de/db/conf/mhci/', 'B', '人机交互与普适计算', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('559', 'UIC', 'IEEE International Conference on Ubiquitous Intelligence and \nComputing', 'IEEE', 'http://dblp.uni-trier.de/db/conf/uic/', 'C', '人机交互与普适计算', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('563', 'CollaborateCom', 'International Conference on Collaborative Computing: \nNetworking, Applications and Worksharing', 'Springer', 'http://collaboratecom.org', 'C', '人机交互与普适计算', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('564', 'CSCWD', 'International Conference on Computer Supported Cooperative \nWork in Design', 'Springer', 'http://dblp.uni-trier.de/db/conf/cscwd/', 'C', '人机交互与普适计算', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('566', 'MobiQuitous', 'International Conference on Mobile and Ubiquitous Systems: \nComputing, Networking and Services', 'Springer', 'http://dblp.uni-trier.de/db/conf/mobiquitous/', 'C', '人机交互与普适计算', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('567', 'AVI', 'International Working Conference on Advanced Visual \nInterfaces', 'ACM', 'http://dblp.uni-trier.de/db/conf/avi/', 'C', '人机交互与普适计算', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('572', 'Cognition', 'Cognition：International Journal of Cognitive \nScience', 'Elsevier', 'http://www.journals.elsevier.com/cognition/', 'B', '交叉/综合/新兴', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('573', 'TASAE', 'IEEE Transactions on Automation Science \nand Engineering', 'IEEE', 'http://dblp.uni-trier.de/db/journals/tase/', 'B', '交叉/综合/新兴', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('574', 'TGARS', 'IEEE Transactions on Geoscience and \nRemote Sensing', 'IEEE', 'http://dblp.uni-trier.de/db/journals/tgrs/', 'B', '交叉/综合/新兴', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('575', 'TITS', 'IEEE Transactions on Intelligent \nTransportation Systems', 'IEEE', 'http://dblp.uni-trier.de/db/journals/tits/', 'B', '交叉/综合/新兴', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('578', 'TCBB', 'IEEE-ACM Transactions on Computational \nBiology and Bioinformatics', 'IEEE/ACM', 'http://dblp.uni-trier.de/db/journals/tcbb/', 'B', '交叉/综合/新兴', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('580', 'JAMIA', 'Journal of the American Medical Informatics \nAssociation', 'BMJ Journals', 'http://dblp.uni-trier.de/db/journals/jamia/', 'B', '交叉/综合/新兴', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('588', 'nan', 'IEEE Geoscience and Remote Sensing \nLetters', 'IEEE', 'http://dblp.uni-trier.de/db/journals/lgrs/', 'C', '交叉/综合/新兴', '期刊');
INSERT INTO `dr_server_ccfinfo` VALUES ('589', 'JBHI', 'IEEE Journal of Biomedical and Health \nInformatics', 'IEEE', 'http://dblp.uni-trier.de/db/journals/titb/', 'C', '交叉/综合/新兴', '期刊');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('597', 'BIBM', 'IEEE International Conference on Bioinformatics \nand Biomedicine', 'IEEE', 'http://dblp.uni-trier.de/db/conf/bibm/', 'B', '交叉/综合/新兴', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('599', 'ISMB', 'International conference on Intelligent Systems for \nMolecular Biology', 'Oxford Journals', 'http://www.iscb.org/about-ismb', 'B', '交叉/综合/新兴', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('600', 'RECOMB', 'International Conference on Research in \nComputational Molecular Biology', 'Springer', 'http://dblp.uni-trier.de/db/conf/recomb/', 'B', '交叉/综合/新兴', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('601', 'AMIA', 'American Medical Informatics Association \nAnnual Symposium', 'AMIA', 'http://dblp.uni-trier.de/db/conf/amia/', 'C', '交叉/综合/新兴', '会议');
...
INSERT INTO `dr_server_ccfinfo` VALUES ('604', 'nan', 'IEEE International Conference on Cloud \nComputing', 'IEEE', 'http://dblp.uni-trier.de/db/conf/IEEEcloud/', 'C', '交叉/综合/新兴', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('605', 'SMC', 'IEEE International Conference on Systems, \nMan, and Cybernetics', 'IEEE', 'https://dblp.uni-trier.de/db/conf/smc/', 'C', '交叉/综合/新兴', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('606', 'COSIT', 'International Conference on Spatial Information \nTheory', 'ACM', 'http://dblp.uni-trier.de/db/conf/cosit/', 'C', '交叉/综合/新兴', '会议');
INSERT INTO `dr_server_ccfinfo` VALUES ('607', 'ISBRA', 'International Symposium on Bioinformatics \nResearch and Applications', 'Springer', 'https://dblp.uni-trier.de/db/conf/isbra/', 'C', '交叉/综合/新兴', '会议');
